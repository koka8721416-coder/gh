...
{
type: "mcq",
text: "يتكون الجدار الجيري في أصداف الفورامنيفرا من معدن :",
options: ["الكلسيت", "السليكا", "الكبريت"],
correct: 0,
explanation: "الإجابة الصحيحة: الكلسيت"
},

{
type: "mcq",
text: "تكثر أعداد الفورامنيفرا القاعية فوق القيعان البحرية :",
options: ["الغرينية", "الرملية", "الحصوية"],
correct: 0,
explanation: "الإجابة الصحيحة: الغرينية"
},

{
type: "mcq",
text: "توجد أصداف الفورامنيفرا في الصخور الرسوبية مثل :",
options: ["الكونجلوميرات", "الجبس", "المارل والطفلة"],
correct: 2,
explanation: "الإجابة الصحيحة: المارل والطفلة"
},

{
type: "mcq",
text: "تأخذ بعض أصداف الفورامنيفرا ذات الحجرات الشكل :",
options: ["الكروي", "الحلزوني", "المخروطي"],
correct: 0,
explanation: "الإجابة الصحيحة: الكروي"
},

{
type: "mcq",
text: "يكون مكان النسيج في الأصداف ذات اللفات المطروحة على شكل :",
options: ["سريع", "بطيء", "دائري"],
correct: 2,
explanation: "الإجابة الصحيحة: دائري"
},

{
type: "mcq",
text: "تظهر الأقدام الكاذبة في الفورامنيفرا وظيفتها :",
options: ["الحركة والتغذية", "التنفس", "الهضم"],
correct: 0,
explanation: "الإجابة الصحيحة: الحركة والتغذية"
},

{
type: "mcq",
text: "تتحمل بعض أنواع الفورامنيفرا نسبة الأكسجين المذاب بـ :",
options: ["النقص", "الزيادة", "الثبات"],
correct: 0,
explanation: "الإجابة الصحيحة: النقص"
},

{
type: "mcq",
text: "يوجد الجانب البيئي في الأصداف ذات التربة :",
options: ["الخضراء", "الرملية", "الطينية"],
correct: 0,
explanation: "الإجابة الصحيحة: الخضراء"
},

{
type: "mcq",
text: "تشمل المخاطر الإيجابية التي يتعرض لها حيوان الفورامنيفرا :",
options: ["تغير درجة الحرارة", "نقص الغذاء", "زيادة الأكسجين"],
correct: 0,
explanation: "الإجابة الصحيحة: تغير درجة الحرارة"
},

{
type: "mcq",
text: "تشمل المشاكل البيئية التي يتعرض لها حيوان الفورامنيفرا :",
options: ["تغير درجة الحرارة", "الملوحة", "الضغط"],
correct: 0,
explanation: "الإجابة الصحيحة: تغير درجة الحرارة"
}
...
{
type: "tf",
text: "تؤدي الفتحات والثقوب وظيفتها داخل وخارج صدفة الفورامنيفرا في تنظيم دخول وخروج السوائل.",
correct: true,
explanation: "العبارة صحيحة"
},

{
type: "tf",
text: "تحتوي فراغات الطين البحرية العميقة على مغذيات قليلة وتكون أصداف الفورامنيفرا ذات شكل مغزلي.",
correct: true,
explanation: "العبارة صحيحة"
},
...
{
type: "tf",
text: "يزداد عمق النطاق الضوئي في المناطق القطبية ويقل في المناطق الاستوائية.",
correct: true,
explanation: "العبارة صحيحة"
},
...
{
type: "tf",
text: "يسمى الجانب الذي تظهر فيه حجرات اللفة الأخيرة في الأصداف ذات اللفات المطروحة بالجانب الظهري.",
correct: true,
explanation: "العبارة صحيحة"
},
...
{
type: "tf",
text: "تتميز أنواع الفورامنيفرا التي تعيش فوق القيعان الصلبة بأن أصدافها تكون قرصية أو حلقية أو مروحية.",
correct: true,
explanation: "العبارة صحيحة"
}
